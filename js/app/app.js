...
var bar = new ProgressBar.Line(course_com, {
  strokeWidth: 2,
  easing: 'easeInOut',
  duration: 1400,
  color: '#32da39',
  ...
  step: (state, bar) => {
    bar.setText(Math.round(bar.value() * 100) + ' %');
                ...
                .state('website-courses.list', {
                        url: '/list',
                        templateUrl: 'website/course-detail-page.html',
                        controller: ['$scope', function($scope){
                            $scope.app.settings.htmlClass = htmlClass.website;
                            $scope.app.settings.bodyClass = '';
                            
                            
var bar = new ProgressBar.Line(lesson_completion_bar, {
  strokeWidth: 2,
  easing: 'easeInOut',
  duration: 1400,
  color: '#32da39',
  ...
  step: (state, bar) => {
    bar.setText(Math.round(bar.value() * 100) + '%');
                            ...
                            // For Topic Progress bar 1
                        var bar = new ProgressBar.Circle(lesson_video_progress, {
                          strokeWidth: 10,
                          easing: 'easeInOut',
                          duration: 1400,
                          color: '#379dfd',
                        ...
                        bar.animate(0.9);  // Number from 0.0 to 1.0
                            ...
                            // For Topic Progress bar 2
                        var bar = new ProgressBar.Circle(lesson_video_progress_2, {
                          strokeWidth: 10,
                          easing: 'easeInOut',
                          duration: 1400,
                          color: '#379dfd',
                    ...
                    // For Topic Progress bar 3
                        var bar = new ProgressBar.Circle(lesson_video_progress3, {
                          strokeWidth: 7,
                          easing: 'easeInOut',
                          duration: 1400,
                          color: '#379dfd',
                ...
                .state('website-take-notes-page', {
                        url: '/notes-page',
                        templateUrl: 'website/take-notes-page.html',
                        controller: ['$scope', function($scope){
                            $scope.app.settings.htmlClass = htmlClass.website;
                            $scope.app.settings.bodyClass = '';
                            
                             // For Topic Progress bar 4
                            var bar = new ProgressBar.Circle(lesson_video_progress4, {
                          strokeWidth: 7,
                          easing: 'easeInOut',
                          duration: 1400,
                          color: '#379dfd',
                ...
                .state('website-ask-questions-page', {
                        url: '/question-page',
                        templateUrl: 'website/ask-questions-page.html',
                        controller: ['$scope', function($scope){
                            $scope.app.settings.htmlClass = htmlClass.website;
                            $scope.app.settings.bodyClass = '';
                            
                            
                             // For Topic Progress bar 5
                            var bar = new ProgressBar.Circle(lesson_video_progress5, {
                          strokeWidth: 7,
                          easing: 'easeInOut',
                          duration: 1400,
                          color: '#379dfd',
	...
	function init() {
		...
		var container = document.getElementById( 'slide_st-container' ),
			buttons = Array.prototype.slice.call( document.querySelectorAll( '#slide_st-trigger-effects > button' ) ),
			// event type (if mobile use touch events)
			eventtype = mobilecheck() ? 'touchstart' : 'click',
			resetMenu = function() {
				classie.remove( container, 'slide_st-menu-open' );
			},
			bodyClickFn = function(evt) {
				if( !hasParentClass( evt.target, 'slide_st-menu' ) ) {
					resetMenu();
		...
		buttons.forEach( function( el, i ) {
			...
			el.addEventListener( eventtype, function( ev ) {
				ev.stopPropagation();
				ev.preventDefault();
				container.className = 'slide_st-container'; // clear
				classie.add( container, effect );
				setTimeout( function() {
					classie.add( container, 'slide_st-menu-open' );
				}, 25 );
...
// For Lesson progress bar                            
var bar = new ProgressBar.Line(lessonAllTopic, {
  strokeWidth: 2,
  easing: 'easeInOut',
  duration: 1400,
  color: '#32da39',
